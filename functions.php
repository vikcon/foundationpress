...
function html5blank_header_scripts()
{
    if (!is_admin()) {
		...
		wp_register_script('jquery', ("http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"),true); // jQuery
    	wp_enqueue_script('jquery'); // Enqueue it!
		
		wp_register_script('foundation', get_template_directory_uri() . '/js/foundation.min.js', false, true); // Custom scripts
        wp_enqueue_script('foundation'); // Enqueue it!
		
		wp_register_script('jquerynoconflict', (get_template_directory_uri() . '/js/jQuery-noConflict.js'), false, true); // jQuery No Conflict (reviere)
    	wp_enqueue_script('jquerynoconflict'); // Enqueue it!
    	
		wp_register_script('modernizr', get_template_directory_uri() . '/js/vendor/custom.modernizr.js',true); // Modernizr 
...
function html5blank_styles()
{
    ...
    wp_register_style('html5blank', get_template_directory_uri() . '/style.css', true);
    wp_enqueue_style('html5blank'); // Enqueue it!  //Comment by vikram
}
